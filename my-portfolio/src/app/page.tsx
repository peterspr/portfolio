  ...
  return (
    <main className="font-sans">
      ...
      <section className="flex flex-col-reverse sm:flex-row items-center justify-between min-h-[90vh] px-6 py-20 bg-gradient-to-br from-white to-gray-100">
        <div className="sm:w-1/2 text-center sm:text-left sm:px-12">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center sm:justify-start">
            ...
            <Link href="/resume.pdf" target="_blank" className="border border-black px-5 py-2 rounded-full text-black hover:bg-black hover:text-white transition">Download Resume</Link>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 text-sm">
            <div>
              ...
              <div className="flex flex-wrap gap-2">
                <span className="bg-gray-900 text-white px-3 py-1 rounded-full">Python</span>
                <span className="bg-gray-900 text-white px-3 py-1 rounded-full">JavaScript</span>
                <span className="bg-gray-900 text-white px-3 py-1 rounded-full">TypeScript</span>
                <span className="bg-gray-900 text-white px-3 py-1 rounded-full">C/C++</span>
              </div>
            </div>
            <div>
              <h3 className="font-semibold mb-2 text-black">Frameworks & Tools</h3>
              <div className="flex flex-wrap gap-2">
                <span className="bg-gray-900 text-white px-3 py-1 rounded-full">React</span>
                <span className="bg-gray-900 text-white px-3 py-1 rounded-full">Node.js</span>
                <span className="bg-gray-900 text-white px-3 py-1 rounded-full">Docker</span>
                <span className="bg-gray-900 text-white px-3 py-1 rounded-full">Git</span>
              </div>
            </div>
            <div>
              <h3 className="font-semibold mb-2 text-black">Concepts</h3>
              <div className="flex flex-wrap gap-2">
                <span className="bg-gray-900 text-white px-3 py-1 rounded-full">REST APIs</span>
                <span className="bg-gray-900 text-white px-3 py-1 rounded-full">CI/CD</span>
                <span className="bg-gray-900 text-white px-3 py-1 rounded-full">TDD</span>
                <span className="bg-gray-900 text-white px-3 py-1 rounded-full">OOP</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <section id="projects" className="bg-gray-50 py-20 px-6">
        <div className="max-w-5xl mx-auto">
          <h2 className="text-3xl font-bold mb-12 text-center text-black">Featured Projects</h2>
      ...
      <section id="contact" className="py-20 px-6 text-center">
        ...
        <p className="mb-6 text-gray-900">Let&apos;s build something great together!</p>
